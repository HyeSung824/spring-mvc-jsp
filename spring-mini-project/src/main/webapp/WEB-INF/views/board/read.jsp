                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="text-right">
                            <a href="${pageContext.request.contextPath}/board/main" class="btn btn-primary">목록보기</a>
                            <a href="${pageContext.request.contextPath}/board/modify" class="btn btn-info">수정하기</a>
                            <a href="${pageContext.request.contextPath}/board/delete" class="btn btn-danger">삭제하기</a>
                        </div>
                    </div>
                </div>
            </div>
