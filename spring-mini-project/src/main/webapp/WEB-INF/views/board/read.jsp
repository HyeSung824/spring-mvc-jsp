                ...
                <div class="card-body">
                    ...
                    <c:if test="${readContentBean.content_file != null}">
                        <div class="form-group">
                            ...
                            <img src="${pageContext.request.contextPath}/upload/${readContentBean.content_file}" width="100%"/>
                        </div>
                    </c:if>
                    <div class="form-group">
                        <div class="text-right">
                            <a href="${pageContext.request.contextPath}/board/main?board_info_idx=${board_info_idx}&page=${page}" class="btn btn-primary">목록보기</a>
                            <c:if test="${loginUserBean.user_idx eq readContentBean.content_writer_idx}">
                                <a href="${pageContext.request.contextPath}/board/modify?board_info_idx=${board_info_idx}&content_idx=${content_idx}&page=${page}" class="btn btn-info">수정하기</a>
                                <a href="${pageContext.request.contextPath}/board/delete?board_info_idx=${board_info_idx}&content_idx=${content_idx}" class="btn btn-danger">삭제하기</a>
                            </c:if>
                        </div>
                    </div>
                </div>
