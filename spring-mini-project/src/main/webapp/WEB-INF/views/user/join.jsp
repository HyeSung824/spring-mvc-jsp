...
<head>
    ...
    <script>
        function checkUserIdExist(){
            ...
            $.ajax({
               url : '${pageContext.request.contextPath}/user/checkUserIdExist/' + user_id,
                type : 'get',
                dataType : 'text',
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="card shadow">
                <div class="card-body">
                    <%--@elvariable id="joinUserBean" type="kr.co.softcampus.beans.UserBean"--%>
                    <form:form modelAttribute="joinUserBean" action="${pageContext.request.contextPath}/user/join_pro" method="post">
                        <form:hidden path="userIdExist"/>
                        <div class="form-group">
                            <form:label path="user_name">이름</form:label>
                            <form:input path="user_name" cssClass="form-control"/>
                            <form:errors path="user_name" cssStyle="color: red"/>
                        </div>
                        <div class="form-group">
                            <form:label path="user_id">아이디</form:label>
                            <div class="input-group">
                                <form:input path="user_id" cssClass="form-control" onkeypress="resetUserIdExist()"/>
