...
<body>
<%-- c:import : 동일한 웹 어플리케이션 뿐만 아니라 외부의 다른 자원을 읽어와 포함시킨다. --%>
            ...
            <div class="col-lg-6" style="margin-top:20px">
                <div class="card shadow">
                    <div class="card-body">
                            ...
                            <tbody>
                                <c:forEach var="obj" items="${sub_list}">
                                    <tr>
                                        ...
                                        <th>
                                            <a href='${pageContext.request.contextPath}/board/read?board_info_idx=${board_list[idx.index].board_info_idx}&content_idx=${obj.content_idx}&page=1'>
                                                ${obj.content_subject}
                                            </a>
                                        </th>
                        ...
                        <a href="${pageContext.request.contextPath}/board/main?board_info_idx=${board_list[idx.index].board_info_idx}" class="btn btn-primary">더보기</a>
                    </div>
                </div>
            </div>
        </c:forEach>
